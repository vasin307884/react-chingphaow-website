    ...
    return (
      <div >
        ...
        <nav class="navbar1 navbar1-expand-md navbar1-light bg-white fixed-top sticky-navigation">
            ...
            <button class="navbar1-toggler navbar1-toggler-right border-0" type="button" data-toggle="collapse" 
                    data-target="#navbar1Collapse" aria-controls="navbar1Collapse" aria-expanded="false" aria-label="Toggle navigation">
            ...
            <div class="collapse navbar1-collapse" id="navbar1Collapse">
                ...
                <Link to="/login"><p class="mb-0 mx-3"><a class="page-scroll font-weight-bold" href="#contact">Login</a></p></Link>
                </form>
            </div>
        </nav>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-8 mx-auto my-auto text-center">
                        <h1>A project of “Chingphaow Application” is created for Chiang-Rai.</h1>
                        <p class="lead mt-4 mb-5">
                        In the northern part of <b>Thailand</b> , there are mountains, forests and plantations of the villagers, which often causes wildfires during the dry season.
                        </p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 mx-auto text-center">
                        <h4 class="dot-circle font-weight-normal">We intend to create websites and application in order to improve the health of everyone.</h4>
                    </div>
                ...
                <div class="row mt-5" id="about">
                    <div class="col-md-6 order-2 order-md-1 my-md-auto">
                        ...
                        Chingphaow is a method of Prescribe Burning which uses fire for forest management. Burning is the main objective. To reduce the amount of fuel in the forest This is to reduce the chance of forest fires. Or if a forest fire occurs The intensity and danger of the fire (Fire Hazard) will be less able to control the fire easily and safely.
                        </p>
                        <a href="#" class="btn1 btn1-primary">Read more</a>
                    </div>
                    <div class="col-md-6 order-1 order-md-2">
                        <img src={logo} class="img-fluid d-block mx-auto" alt="Google Design"/>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <img src={alert} class="img-fluid d-block mx-auto" alt="Facebook Messenger"/>
                    </div>
                    ...
                    <div class="col-md-6 my-md-auto">
                        <h3>Warning </h3>
                        <p class="text-muted lead">
                        Chingohaow in the period of relative calm wind The weather is not very hot. And the relative humidity of the air is quite high With an appropriate time for the competition between 2 am and 5 pm
                ...
                <div class="row" id="download">
                    <div class="col-md-6 order-2 order-md-1 my-md-auto">
                        ...
                        <a href="#" class="btn1 btn1-primary">View project</a>
                    </div>
                    <div class="col-md-6 order-1 order-md-2">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-7 mx-auto text-center">
                        ...
                        Our methods will have get location ,system analyze ,update status
                        ,start process chingphaow.
                        </p>
                    </div>
                </div>
                <div class="row mt-5">
                    <div class="col-md-7 mx-auto timeline">
                        <div class="media pb-5">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-muted">When your send location on mobile application.System will receive your location.</p>
                            </div>
                        </div>
                        <div class="media pb-5">
                            <div class="icon-box mt-1">
                            ...
                            <div class="media-body">
                                ...
                                <p class="text-muted">The system will analyze your data with Temperature, weather, humidity. To find the right date and time.</p>
                            </div>
                        </div>
                        <div class="media pb-5">
                            <div class="icon-box mt-1">
                            ...
                            <div class="media-body">
                                <h5>Update status</h5>
                                <p class="text-muted">The staff will change your status to yellow to be ready to burn.</p>
                            </div>
                        </div>
                        <div class="media pb-5">
                            <div class="icon-box mt-1">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h5>Finsih !</h5>
                                <p class="text-muted">When the status turns green, the burn has finished.</p>
                            </div>
                        </div>
                ...
                <div class="row mt-7">
                    <div class="col-md-6 mx-auto text-center">
                        ...
                        <p class="lead text-muted mb-4">The purpose of this project to reduce the occurrence of wildfires, pollution problems ,and to manage schedules for burning of villagers. Therefore, there is a burning control process called “Ching-Phaow (Early burning)”
                        </p>
